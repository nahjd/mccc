...
function Adress() {
    return (
        <section className='RestaurantAdress'>
            <div className="adresscontainer">
                <div className="restoraunt">
                    <div className="text">
                        <h1>Restoranların ünvanları</h1>
                    </div>
                    <img src="https://mcdonalds.az/images/a03562ae6f6f097c2a959b339ff4e405.jpg" alt="" />
                </div>
                <div className="adress">
                    <div className="adress1">
                        <div className="leftadress">
                            ...
                            <p><b>Dine-in:</b>  08:00 – 02:00
                            </p>
                            <p><b>McDelivery®:</b> 08:00 – 02:00
                            </p>
                    ...
                    <div className="adress7">
                        <div className="leftadress">
                            ...
                            <p><b>Dine-in: </b>  09:00 – 01:00
                            </p>
                            <p><b>Drive thru: </b> 07:30 - 01:00</p>
                            <p><b>McDelivery®: </b>  10:00 – 23:00
                            </p>
                    ...
                    <div className="adress8">
                        <div className="leftadress">
                            ...
                            <p><b> Telefon nömrəsi:  </b>  <a href="tel: +994 12 505 99 04">+994 12 505 99 04</a> </p>
                            <p><b>Dine-in: </b>    08:00-00:00

                            </p>

                            <p><b>McDelivery®: </b>   08:00 – 00:00
                    ...
                    <div className="adress9">
                        <div className="leftadress">
                            ...
                            <p><b> Telefon nömrəsi:  </b>  <a href="tel: +994 12 505 99 05">+994 12 505 99 05</a> </p>
                            <p><b>Dine-in: </b>  08:00-01:00

                            </p>
                            <p><b>Drive thru:</b> 07:30-03:00
                            </p>

                            <p><b>McDelivery®: </b>  08:00-03:00
                        ...
                        <div className="rightadress">
                            ...
                            <p><b> Telefon nömrəsi:  </b> <a href="tel:+994 12 525 89 20">  +994 12 525 89 20</a> </p>
                            <p><b>Dine-in:</b>    08:00-01:00
                    ...
                    <div className="adress10">
                        <div className="leftadress">
                            ...
                            <p><b> Telefon nömrəsi:  </b>  <a href="tel:+994 12 525 87 80">+994 12 525 87 80</a> </p>
                            <p><b>Dine-in: </b>    08:00 – 00:00


                            </p>
                            <p><b>Drive thru:</b>  07:30 – 01:00

                            </p>

                            <p><b>McDelivery®: </b>   10:00 – 01:00
                        ...
                        <div className="rightadress">
                            ...
                            <p><b> Telefon nömrəsi:  </b> <a href="tel:+994 12 599 14 99">  +994 12 599 14 99</a> </p>
                            <p><b>Dine-in:</b> 09:00-23:00
                            </p>
                        </div>
                    </div>
                    <div className="adress11">
                        ...
                        <div className="rightadress">
                            ...
                            <p><b>Drive thru:</b>  07:30 – 02:00
                            </p>
                            <p><b>Dine-in:</b>  08:00 – 01:00
                            </p> <p><b>McDelivery®:</b> 08:00 – 02:00
                            </p>
                        </div>
                    </div>
                    <div className="adress12">
                        <div className="leftadress">
                            ...
                            <p><b> Telefon nömrəsi:  </b>  <a href="tel: +994 77 488 01 23">+994 77 488 01 23</a> </p>
                            <p><b>Dine-in: </b>   08:00 – 01:00
                            </p>
                            <p><b>McDelivery®: </b>   08:00 – 01:00
                            </p>
            ...
            <footer className="footercard" style={{display:"flex", marginLeft:"400px", fontSize:"18px"}}>
